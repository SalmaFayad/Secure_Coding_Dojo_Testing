...
async function waitForInsertUser(){
    while(insertUserPromise === null) {
        await new Promise((resolve) => setTimeout(resolve, 100)); //edited by Team#4 Introduce a small delay to avoid blocking the event loop

    } //wait for promise to get initialized
